...
import dev.xaihi.autismclient.common.gui.packui.PackUiDropdown;
...
public class PackUtilProxyConfigScreen extends Screen {
    ...
    public static final int[] TIMEOUT_VALUES = {1000, 2000, 3000, 5000, 7500, 10000, 15000};
    public static final int[] THREAD_VALUES = {1, 2, 4, 8, 12, 16, 24, 32, 48, 64};
    public static final int[] RETRY_VALUES = {0, 1, 2, 3, 5};
    public static final int[] PRUNE_LATENCY_VALUES = {0, 500, 1000, 1500, 2000, 3000, 5000, 10000};
    public static final int[] PRUNE_COUNT_VALUES = {0, 25, 50, 100, 250, 500, 1000};

    public final Screen parent;
    public final List<PackUiOverlayButton> buttons = new ArrayList<>();
    public final List<PackUiDropdown> dropdowns = new ArrayList<>();
    public final List<ConfigRow> rows = new ArrayList<>();
    ...
    public void addDropdownRow(String label, String hint, int current, IntConsumer setter, int[] options, ValueFormatter formatter, int panelX, int y) {
    ...
    public void addToggleRow(String label, boolean enabled, String hint, BooleanConsumer setter, int panelX, int y) {
    ...
    public int selectedOptionIndex(int current, int[] options) {
    ...
    public List<String> optionLabels(int[] options, ValueFormatter formatter) {
    ...
    public void renderRow(GuiGraphicsExtractor graphics, ConfigRow row, int panelX) {
        int x = panelX + 12;
        int y = row.y();
    ...
    public MouseButtonEvent virtualEvent(MouseButtonEvent event) {
    ...
    public void drawText(GuiGraphicsExtractor graphics, String text, int x, int y, int color, boolean right) {
        drawText(graphics, text, x, y, color, right, Integer.MAX_VALUE);
    }

    public void drawText(GuiGraphicsExtractor graphics, String text, int x, int y, int color, boolean right, int maxWidth) {
    ...
    public String formatMs(int value) {
    ...
    public record ConfigRow(String label, String value, String hint, int y, boolean toggle, boolean enabled) {
    }
}

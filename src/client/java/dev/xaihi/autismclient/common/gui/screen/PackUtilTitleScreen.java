...
public class PackUtilTitleScreen extends Screen {
    public static final Identifier LOGO = Identifier.fromNamespaceAndPath("autismclient", "textures/gui/title/autism_client_logo.png");
    public static final Identifier BUTTON_CLICK_SOUND_ID = Identifier.fromNamespaceAndPath("autismclient", "gui.main_menu_click");
    public static final SoundEvent BUTTON_CLICK_SOUND = SoundEvent.createVariableRangeEvent(BUTTON_CLICK_SOUND_ID);
    public static final Identifier LANGUAGE_ICON = Identifier.fromNamespaceAndPath("autismclient", "textures/gui/title/icons/language.png");
    public static final Identifier ACCESSIBILITY_ICON = Identifier.fromNamespaceAndPath("autismclient", "textures/gui/title/icons/accessibility.png");
    public static final Identifier ESSENTIAL_ICON = Identifier.fromNamespaceAndPath("autismclient", "textures/gui/title/icons/essential.png");
    public static final Identifier TEXT_SINGLEPLAYER = buttonText("singleplayer");
    public static final Identifier TEXT_MULTIPLAYER = buttonText("multiplayer");
    public static final Identifier TEXT_REALMS = buttonText("minecraft_realms");
    public static final Identifier TEXT_OPTIONS = buttonText("options");
    public static final Identifier TEXT_QUIT = buttonText("quit_game");
    public static final Identifier MODMENU_ICON = Identifier.fromNamespaceAndPath("autismclient", "textures/gui/title/icons/modmenu.png");
    public static final int LOGO_TEXTURE_WIDTH = 516;
    public static final int LOGO_TEXTURE_HEIGHT = 144;
    public static final int LOGO_MAX_WIDTH = 320;
    public static final int LOGO_MAX_HEIGHT = 72;
    public static final int ICON_TEXTURE_SIZE = 32;
    public static final int BUTTON_TEXT_TARGET_HEIGHT = 14;
    public static final Component TITLE = Component.translatable("narrator.screen.title");

    public final PackUiTheme theme = new PackUiTheme();
    public final List<MenuButton> buttons = new ArrayList<>();
    public final String modCountText = createModCountText();
    public final boolean modMenuLoaded = FabricLoader.getInstance().isModLoaded("modmenu");
    public final boolean essentialLoaded = FabricLoader.getInstance().isModLoaded("essential");
    public List<MeteorCreditLine> meteorCredits = List.of();
    public boolean meteorCreditsLoadFailed;
    public int footerY;
    ...
    public Component multiplayerDisabledReason() {
    ...
    public void renderLogo(GuiGraphicsExtractor graphics) {
        int screenW = PackUtilUiScale.getVirtualScreenWidth();
        int screenH = PackUtilUiScale.getVirtualScreenHeight();
        int menuTop = Math.max(82, screenH / 4 + 48);
    ...
    public void renderFooter(GuiGraphicsExtractor graphics, float mouseX, float mouseY) {
        PackUiText.draw(graphics, this.font, modCountText, PackUiAssets.FONT_BODY, theme.color(PackUiTone.MUTED), 2, footerY, false);
    }

    public void renderMeteorCredits(GuiGraphicsExtractor graphics) {
    ...
    public List<MeteorCreditLine> getMeteorCredits() {
    ...
    public static MeteorCreditLine meteorCreditLine(Object addon) throws ReflectiveOperationException {
    ...
    public static String stringField(Class<?> type, Object instance, String name) throws ReflectiveOperationException {
        Object value = type.getField(name).get(instance);
        return value instanceof String text ? text : null;
    }

    public static String[] authorsField(Class<?> type, Object instance) throws ReflectiveOperationException {
        Object value = type.getField("authors").get(instance);
        if (!(value instanceof String[] authors)) return new String[0];
        return authors;
    }

    public static int addonColor(Class<?> type, Object instance) throws ReflectiveOperationException {
    ...
    public static Identifier buttonText(String name) {
    ...
    public void renderCustomTooltip(GuiGraphicsExtractor graphics, Component tooltip, float uiMouseX, float uiMouseY) {
    ...
    public static String createModCountText() {
        int modCount = FabricLoader.getInstance().getAllMods().size();
        return modCount + (modCount == 1 ? " Mod" : " Mods");
    }

    public record MeteorCreditLine(List<MeteorCreditSegment> segments) {
        public int width(net.minecraft.client.gui.Font font) {
            int width = 0;
    ...
    public record MeteorCreditSegment(String text, int color) {
    }
    ...
    public final class MenuButton {
        ...
        public final Identifier labelTexture;
        public final int labelTextureWidth;
        public final int labelTextureHeight;
        public final int labelDrawWidth;
        public final int labelDrawHeight;
        public final boolean enabled;
        public final Runnable onPress;
        public Component tooltip;

        public MenuButton(int x, int y, int width, int height, Component label, Identifier icon, Identifier labelTexture,
        ...
        public MenuButton withTooltip(Component tooltip) {
        ...
        public void render(GuiGraphicsExtractor graphics, float mouseX, float mouseY, float delta) {
        ...
        public PackUiButtonFeedback feedback() {

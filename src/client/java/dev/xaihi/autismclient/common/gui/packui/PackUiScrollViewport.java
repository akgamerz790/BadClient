...
public final class PackUiScrollViewport {
    ...
    public int activeBorderColor = 0;

    public final int clipLeft;
    public final int clipTop;
    public final int clipRight;
    ...
    public int getEffectiveViewHeight() {
    ...
    public int getEffectiveClipBottom() {
    ...
    public int quantizeToSteps(int offset) {

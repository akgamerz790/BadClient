...
public final class PackUiToastStack {
    public static final long LIFETIME_MS = 1800L;
    public static final float ENTER_MS = 140.0f;
    public static final float EXIT_MS = 220.0f;
    public static final int MAX_VISIBLE = 4;
    public static final int GAP = 4;
    public static final int HEIGHT = 18;

    public final List<ToastEntry> toasts = new ArrayList<>();
    ...
    public record ToastEntry(String message, long shownAtNanos, int accentColor) {
    }
}

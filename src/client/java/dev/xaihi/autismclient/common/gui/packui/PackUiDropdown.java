...
public final class PackUiDropdown {
    ...
    public static boolean suppressUnderlyingPointerUntilRelease;
    ...
    public final IntConsumer onSelect;
    ...
    public void renderButton(GuiGraphicsExtractor context, Font font, int mouseX, int mouseY) {
    ...
    public void renderMenu(GuiGraphicsExtractor context, Font font, int mouseX, int mouseY) {
    ...
    public boolean handleOpenClick(double mouseX, double mouseY) {
    ...
    public void drawBox(GuiGraphicsExtractor context, int x, int y, int width, int height, int fill, int border) {
    ...
    public void drawFill(GuiGraphicsExtractor context, int x0, int y0, int x1, int y1, int color) {
    ...
    public boolean containsOpenMenu(double mouseX, double mouseY) {

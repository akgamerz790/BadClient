...
public class PacketRegenerator {
    ...
    public static final Map<Class<? extends Packet<?>>, PacketHandler<?>> handlers = new HashMap<>();
    ...
    public static <T extends Packet<?>> void register(Class<T> clazz, PacketHandler<T> handler) {
    ...
    public static int getFieldInt(Object obj, String hint, Class<?> type, int index) {
        try {
    ...
    public static void setFieldInt(Object obj, String hint, Class<?> type, int index, int value) throws Exception {
        Field field = findField(obj.getClass(), type, index);
        field.setInt(obj, value);
    }

    public static String getFieldString(Object obj, String hint, int index) {
        try {
    ...
    @SuppressWarnings("unchecked")
    public static <E extends Enum<E>> E getFieldEnum(Object obj, Class<E> enumClass) {
        try {
    ...
    public static Field findField(Class<?> clazz, Class<?> type, int index) throws NoSuchFieldException {

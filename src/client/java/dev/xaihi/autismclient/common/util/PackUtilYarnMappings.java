...
public final class PackUtilYarnMappings {
    public static final String RESOURCE_PATH = "/packutil-inspector-mappings.tsv";
    public static final Map<String, String> CLASS_ALIASES = new HashMap<>();
    public static final Map<String, String> SIMPLE_CLASS_ALIASES = new HashMap<>();
    public static final Map<String, String> METHOD_ALIASES = new HashMap<>();
    public static final Map<String, String> FIELD_ALIASES = new HashMap<>();
    public static volatile boolean loaded;

    public PackUtilYarnMappings() {
    }
    ...
    public static void registerSimpleAlias(String simpleOwner, String alias) {

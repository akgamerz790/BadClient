...
public class DisconnectAction implements MacroAction {
    ...
    public transient List<MacroAction> nextActions = null;
    ...
    public void executeDisconnect(Minecraft mc) {
        if (mc.level != null && mc.getConnection() != null) {
            mc.getConnection().getConnection().disconnect(Component.literal("Disconnected by Macro"));
        }
    }

    public void executeAutoDisconnect(Minecraft mc) {
    ...
    public boolean isMainInventoryEmpty(Minecraft mc) {
    ...
    public void executeKick(Minecraft mc) {
        if (mc.player == null || mc.getConnection() == null) {
            PackUtilClientMessaging.sendPrefixed("Â§cNo player or network connection!");
            return;
        }
    ...
    public void executeKickDupe(Minecraft mc) {
        if (mc.player == null || mc.getConnection() == null) {
            PackUtilClientMessaging.sendPrefixed("Â§cNo player or network connection!");
            return;
        }
    ...
    public boolean findAndUseBundle(Minecraft mc) {
    ...
    public boolean validateLagMethod(Minecraft mc) {
        switch (lagMethod) {
            case BOAT_NBT -> {
    ...
    public void sendLagPackets(Minecraft mc) {
        switch (lagMethod) {
            case CLICK_SLOT -> {
    ...
    public void sendKickPacket(Minecraft mc) {
        switch (kickMethod) {

...
public class ServerTickTracker {
    public static final long TICK_DURATION_NANOS = 50_000_000L;
    public static final Minecraft MC = Minecraft.getInstance();

    public static final long MIN_WARMUP_MS = 2000;
    public static final int MIN_SAMPLES = 40;

    public static final int WORLD_TIME_SAMPLE_COUNT = 60;
    public static final long[] worldTimeSamples = new long[WORLD_TIME_SAMPLE_COUNT];
    public static int worldTimeSampleIndex = 0;
    public static int worldTimeSamplesFilled = 0;

    public static volatile long trackingStartTime = 0;
    public static volatile long lastWorldTimePacket = 0;

    public static volatile long averagedTickPhase = 0;
    public static volatile long baseTickTime = 0;

    public static volatile long lastEntityPacketTime = 0;
    public static volatile int entityPacketBurstCount = 0;
    public static final long BURST_THRESHOLD_NANOS = 5_000_000L;
    ...
    public static void updateAveragedPhase() {

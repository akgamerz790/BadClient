...
public final class PackUtilSharedState {
    public static final PackUtilSharedState INSTANCE = new PackUtilSharedState();

    public volatile boolean sendGuiPackets = true;
    public volatile boolean delayGuiPackets;
    public volatile boolean allowSignEditing = true;
    public volatile boolean allowBookUpdate = true;
    public volatile boolean bypassResourcePack;
    public volatile boolean resourcePackForceDeny;
    public volatile boolean xCarryActive;
    public volatile boolean xCarryForced;
    public volatile BlockPos lastInteractedBlockPos = null;
    public volatile PackUtilContainerTarget lastContainerTarget = null;
    public volatile boolean useCustomPackets = false;
    public Set<Class<? extends Packet<?>>> c2sPackets = new HashSet<>();
    public Set<Class<? extends Packet<?>>> s2cPackets = new HashSet<>();

    public final List<QueuedPacket> delayedPackets = new CopyOnWriteArrayList<>();

    public volatile boolean staggeredPacketSend = false;
    public volatile int staggeredSendDelay = 1;
    public final List<QueuedPacket> staggeredQueue = new CopyOnWriteArrayList<>();
    public final List<QueuedPacket> staggeredDisplayQueue = new CopyOnWriteArrayList<>();
    public final List<QueuedPacket> lastFlushedQueue = new CopyOnWriteArrayList<>();
    public final AtomicInteger queueRenderRevision = new AtomicInteger();
    public int staggeredTickCounter = 0;
    public ClientPacketListener staggeredNetworkHandler = null;
    public int staggeredTotal = 0;
    public boolean activeSendUsesExplicitDelays = false;

    public enum DelayMode { TICKS, MS }
    public volatile DelayMode delayMode = DelayMode.TICKS;
    public DelayMode staggeredDelayMode = DelayMode.TICKS;
    public long flushStartNanos = 0;
    public int flushStartClientTick = 0;
    public long activeCaptureLastNanos = -1;
    public int activeCaptureLastClientTick = -1;
    public int activeCaptureTailDelay = 0;
    public String pendingQueueCompletionMessage = null;

    public Screen storedScreen;
    public AbstractContainerMenu storedAbstractContainerMenu;
    public boolean isFlushing = false;

    public boolean fabricatorOverlayVisible = false;
    public int fabricatorOverlayX = 500;
    public int fabricatorOverlayY = 5;

    public String fabricatorSlotValue = "0";
    public String fabricatorItemNameValue = "";
    public String fabricatorTimesValue = "1";
    public int fabricatorActionIndex = 0;
    public int fabricatorButtonIndex = 0;
    public boolean fabricatorDropWholeStack = false;
    public boolean fabricatorCraftUseMaxAmount = false;
    public String fabricatorCraftSearchValue = "";
    public int fabricatorCraftSelectedRecipeId = -1;
    public String fabricatorCraftSelectedRecipeKey = "";
    public int fabricatorCraftScrollOffset = 0;
    public final List<CraftAction.CraftEntry> fabricatorCraftPlanEntries = new ArrayList<>();
    public int fabricatorCraftPlanSelectedIndex = -1;
    public int fabricatorCraftPlanScrollOffset = 0;

    public boolean lanSyncOverlayVisible = false;
    public int lanSyncOverlayX = 500;
    public int lanSyncOverlayY = 5;
    public int lanSyncOverlayActiveTab = 0;
    public int lanSyncOverlayScrollOffset = 0;
    public boolean lanSyncOverlayPerUserMode = false;
    public String lanSyncOverlaySelectedMacroName = "";
    public String lanSyncOverlayExpandedExecutePeer = "";
    public String lanSyncOverlaySelectedPeer = "";
    public boolean macroListOverlayVisible = false;
    public int macroListOverlayX = 500;
    public int macroListOverlayY = 250;
    public int macroListOverlayScrollOffset = 0;
    public String macroListOverlaySearch = "";
    public boolean queueEditorOverlayVisible = false;
    public int queueEditorOverlayX = 100;
    public int queueEditorOverlayY = 100;
    public int serverInfoOverlayActiveTab = 0;
    public int serverInfoOverlayPluginScrollOffset = 0;
    public String serverInfoOverlaySelectedPlugin = "";
    public String serverInfoOverlayStateAddress = "";
    public volatile String realServerVersion = "";
    public volatile String realServerVersionAddress = "";
    public int serverInfoOverlayProbeDelayMs = 50;
    public int serverInfoOverlayInfoWidth = 252;
    public int serverInfoOverlayInfoHeight = 258;
    public int serverInfoOverlayPluginWidth = 280;
    public int serverInfoOverlayPluginHeight = 280;

    public boolean macroEditorVisible = false;
    public PackUtilMacro editingMacro = null;
    public int macroEditorPanelX = 400;
    public int macroEditorPanelY = 100;

    public boolean blockSelectorVisible = false;

    public volatile boolean gbreakCaptureMode = false;
    public volatile int gbreakPacketCount = 0;
    public Runnable gbreakCallback = null;
    public final List<QueuedPacket> gbreakCapturedPackets = new ArrayList<>();

    public volatile boolean captureMode = false;
    public volatile long lastCaptureNanos = -1;
    public volatile int lastCaptureClientTick = -1;
    public volatile int clientTickCounter = 0;

    public volatile double serverMsPerTick = 50.0;
    public volatile long lastTimeSyncMs = -1;
    public final Map<String, PackUtilWindowLayout> windowLayouts = new HashMap<>();
    public final Map<String, ServerPluginScan> serverPluginScans = new HashMap<>();
    public final List<String> overlayOrder = new ArrayList<>();
    public String focusedOverlayId = "";

    public PackUtilSharedState() {}
    ...
    public static String normalizeServerPluginContext(String contextSignature) {
        return contextSignature == null ? "" : contextSignature.trim().toLowerCase(Locale.ROOT);
    }

    public static String buildServerPluginScanKey(String address, String contextSignature) {
        String normalizedAddress = normalizeServerAddress(address);
    ...
    public void checkAndResetIdCounter() {
    ...
    public void resetCaptureTiming() {
        lastCaptureNanos = -1;
    ...
    public void saveQueueToHistory(List<QueuedPacket> queue) {
        lastFlushedQueue.clear();
        if (queue == null || queue.isEmpty()) return;
        lastFlushedQueue.addAll(rebuildQueueWithSequentialIds(queue));
    }

    public void stopStaggeredSendLocked() {
    ...
    public void markQueueRenderDirty() {
        queueRenderRevision.incrementAndGet();
    }

    public boolean isActiveStaggerSendLocked() {
        return staggeredNetworkHandler != null && !staggeredQueue.isEmpty();
    }

    public int getElapsedForDelayModeLocked(DelayMode mode) {
    ...
    public int getQueueTailDelayLocked(List<QueuedPacket> queue) {
        int maxDelay = 0;
    ...
    public void insertQueuedPacketSorted(List<QueuedPacket> queue, QueuedPacket packet) {
    ...
    public int computeActiveQueueDelayLocked() {
    ...
    public int computeActiveCapturedQueueDelayLocked() {
    ...
    public int flushDelayedPacketsDirect(ClientPacketListener networkHandler) {
    ...
    public String consumePendingQueueCompletionMessageLocked() {
    ...
    public List<QueuedPacket> rebuildQueueWithSequentialIds(List<QueuedPacket> source) {
    ...
    public static final class ServerPluginScan {
        ...
        public final String contextSignature;
        public final List<String> plugins;
        public final Map<String, List<String>> pluginCommands;
        public final Map<String, String> pluginEvidence;

        public ServerPluginScan(String address, String contextSignature, List<String> plugins, Map<String, List<String>> pluginCommands, Map<String, String> pluginEvidence) {
        ...
        public ServerPluginScan copy() {
            return new ServerPluginScan(address, contextSignature, plugins, pluginCommands, pluginEvidence);
        }

        public static Map<String, List<String>> copyPluginCommands(Map<String, List<String>> source) {
        ...
        public static Map<String, String> copyPluginEvidence(Map<String, String> source) {
            if (source == null || source.isEmpty()) return Collections.emptyMap();
    ...
    public String stripPort(String address) {
    ...
    public void finishGBreakCapture() {
    ...
    public volatile boolean suppressNextContainerClosePacket = false;
    public volatile boolean suppressNextSignUpdatePacket = false;
    public volatile boolean suppressNextBookEditPacket = false;
    public volatile boolean forceNextSignUpdatePacket = false;
    public volatile boolean forceNextBookEditPacket = false;
    ...
    public volatile java.util.function.Consumer<net.minecraft.core.BlockPos> blockCaptureCallback = null;
    public volatile java.util.function.BiConsumer<net.minecraft.core.BlockPos, net.minecraft.core.Direction> directionalBlockCaptureCallback = null;
    ...
    public volatile Runnable attackCaptureCallback = null;
    public volatile Runnable captureCancelCallback = null;
    ...
    public volatile java.util.function.Consumer<String> entityCaptureCallback = null;

    public volatile boolean entityCaptureSpecific = false;

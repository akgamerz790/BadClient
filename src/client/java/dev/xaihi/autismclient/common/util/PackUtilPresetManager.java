...
public class PackUtilPresetManager {
    public static final File PRESETS_FOLDER = new File(AutismClientAddon.FOLDER, "presets");
    public static final PackUtilPresetManager INSTANCE = new PackUtilPresetManager();
    public static final String USER_PRESET_PREFIX = "User Preset ";
    public static final Map<String, String> LEGACY_PACKET_NAME_ALIASES = createLegacyPacketNameAliases();

    public final Gson gson = new GsonBuilder().setPrettyPrinting().create();
    public List<PresetEntry> cachedBuiltInPresetEntries = null;
    public List<PresetEntry> cachedUserPresetEntries = null;
    public String cachedUserPresetSignature = "";
    ...
    public PackUtilPacketPreset captureCurrentPreset(String name) {
    ...
    public PackUtilPacketPreset presetFromClasses(String name,
    ...
    public PackUtilPacketPreset presetFromPacketNames(String name, Set<String> c2sNames, Set<String> s2cNames) {
    ...
    public Set<String> encodePacketNames(Collection<Class<? extends Packet<?>>> packets) {
    ...
    public String encodePacketName(Class<? extends Packet<?>> packetClass) {
        String name = PackUtilPacketRegistry.getName(packetClass);
        return name != null ? name : packetClass.getName();
    }

    @SuppressWarnings("unchecked")
    public Set<Class<? extends Packet<?>>> resolvePacketNames(Collection<String> names, boolean c2s) {
    ...
    public void savePresetObject(PackUtilPacketPreset preset, boolean notify) {
    ...
    public void applyPreset(PackUtilPacketPreset preset) {
        PackUtilModule module = PackUtilModule.get();
    ...
    public String nextAvailableUserPresetName() {
        int index = 1;
        while (true) {
    ...
    public String createUniquePresetName(String preferredName) {
    ...
    public String sanitizePresetName(String name) {
        if (name == null) return null;
        String sanitized = name.trim();
        return sanitized.isEmpty() ? null : sanitized;
    }

    public String normalizePresetName(String name) {
        return name == null ? "" : name.trim().toLowerCase(Locale.ROOT);
    }

    public String normalizePresetPacketName(String packetName) {
    ...
    public void invalidateUserPresetCache() {
        cachedUserPresetEntries = null;
        cachedUserPresetSignature = "";
    }

    public String userPresetFilesSignature() {
        File[] files = PRESETS_FOLDER.listFiles((dir, fileName) -> fileName.endsWith(".json"));
    ...
    public static Map<String, String> createLegacyPacketNameAliases() {

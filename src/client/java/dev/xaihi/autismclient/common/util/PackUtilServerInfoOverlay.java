...
import dev.xaihi.autismclient.common.gui.packui.PackUiInfoRow;
...
import dev.xaihi.autismclient.common.gui.packui.PackUiProgressBar;
...
import dev.xaihi.autismclient.common.gui.packui.PackUiSlider;
...
import dev.xaihi.autismclient.common.gui.packui.PackUiTabStrip;
...
public class PackUtilServerInfoOverlay extends PackUtilOverlayBase {
    ...
    public static final int COMPLETION_ID = 1337;
    ...
    public int panelX = 350;
    public int panelY = 30;
    public int panelW = 236;
    public int panelH = 246;
    ...
    public double resizeStartMouseX, resizeStartMouseY;
    public int resizeStartW, resizeStartH;
    public float pressStartUiX, pressStartUiY;
    public int pressStartPanelX, pressStartPanelY;
    public boolean dragMoved = false;
    public final Font textRenderer;
    public final PackUiTheme theme = new PackUiTheme();
    public final PackUiWindowNode windowNode = new PackUiWindowNode("Server Info");
    public final PackUiSurface surface = new PackUiSurface(theme, windowNode);
    public final PackUiTabStrip tabStrip = new PackUiTabStrip();
    public final PackUiTextField searchField = new PackUiTextField();
    public final PackUiSlider probeDelaySlider = new PackUiSlider();
    public final PackUiProgressBar scanProgressBar = new PackUiProgressBar();
    public final PackUiViewportSlot pluginListSlot = new PackUiViewportSlot();
    public float closeHover = 0.0f;
    public float closeVisibility = 1.0f;
    public boolean pluginScrollbarDragging = false;
    public int pluginScrollbarGrabOffset = 0;
    public long lastUiRebuildMs = 0L;

    public static final String[] TAB_NAMES = {"Info", "Plugins"};
    public int activeTab = 0;

    public final List<ClickRegion> clickRegions = new ArrayList<>();

    public volatile String resolvedIp = null;
    public String lastResolvedAddress = null;
    public volatile boolean resolvingIp = false;

    public final List<String> detectedPlugins = new ArrayList<>();
    public final Map<String, List<String>> pluginCommands = new LinkedHashMap<>();
    public final PackUiSmoothScroll pluginScrollState = new PackUiSmoothScroll();
    public int pluginContentHeight = 0;
    public String selectedPlugin = null;
    public int pluginProbeDelayMs = 50;
    public boolean pluginScanDone = false;
    public boolean pluginScanInProgress = false;
    public long pluginScanStartedAt = 0L;
    public long pluginScanLastResponseAt = 0L;
    public final Set<Integer> pendingPluginProbeIds = new HashSet<>();
    public final Map<Integer, PluginProbeSpec> pluginProbes = new HashMap<>();
    public final Set<String> observedPluginCommands = new TreeSet<>(String.CASE_INSENSITIVE_ORDER);
    public final Deque<PluginProbeRequest> queuedPluginProbes = new ArrayDeque<>();
    public final Map<String, PluginEvidence> pluginEvidence = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    public final Map<String, PluginScanEntry> scanWorkingEntries = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    public long nextPluginProbeSendAt = 0L;
    public int pluginScanTotalSteps = 0;
    public boolean pluginScanCompletionAnnounced = false;

    public String scannedServerAddress = null;
    public String scannedPluginContextSignature = "";
    public String cachedPluginContextServerAddress = "";
    public String cachedPluginContextBrand = "";
    public String cachedPluginContextSignature = "";
    public boolean pluginContextSignatureDirty = true;
    public static final long PLUGIN_SCAN_IDLE_MS = 700L;
    public static final long PLUGIN_SCAN_TIMEOUT_MS = 12000L;
    public static final int DEFAULT_PLUGIN_PROBE_DELAY_MS = 50;
    public static final int MIN_PLUGIN_PROBE_DELAY_MS = 10;
    public static final int MAX_PLUGIN_PROBE_DELAY_MS = 500;
    public static final long PLUGIN_SCAN_SETTLE_MS = 450L;
    public static final int PLUGIN_HEADER_H = 14;
    public static final int SHARED_PANEL_WIDTH = 200;
    public static final int PLUGIN_SETUP_WIDTH = SHARED_PANEL_WIDTH;
    public static final int PLUGIN_SETUP_HEIGHT = 126;
    public static final int PLUGIN_SCANNING_WIDTH = SHARED_PANEL_WIDTH;
    public static final int PLUGIN_SCANNING_HEIGHT = 92;
    public static final int INFO_MIN_WIDTH = SHARED_PANEL_WIDTH;
    public static final int INFO_MIN_HEIGHT = 258;
    public static final int PLUGIN_RESULTS_MIN_WIDTH = SHARED_PANEL_WIDTH;
    public static final int PLUGIN_RESULTS_MIN_HEIGHT = 280;
    public int infoPreferredWidth = INFO_MIN_WIDTH;
    public int infoPreferredHeight = INFO_MIN_HEIGHT;
    public int pluginPreferredWidth = PLUGIN_RESULTS_MIN_WIDTH;
    public int pluginPreferredHeight = PLUGIN_RESULTS_MIN_HEIGHT;
    public static final String[] COMMON_PLUGIN_NAMESPACES = {
    ...
    public static final String[] PLUGIN_LIST_PROBE_COMMANDS = {
        "/plugins ", "/pl ", "/bukkit:plugins ", "/bukkit:pl "
    };
    public static final String[] VERSION_PROBE_COMMANDS = {
        "/ver ", "/version ", "/about ", "/icanhasbukkit ", "/bukkit:ver ", "/bukkit:version "
    };
    public static final String[] HELP_PROBE_COMMANDS = {
        "/help ", "/? ", "/bukkit:help ", "/minecraft:help "
    };
    public static final String ROOT_PROBE_PREFIXES = "abcdefghijklmnopqrstuvwxyz0123456789";
    public static final Map<String, String> ROOT_COMMAND_PLUGIN_ALIASES = Map.ofEntries(
    ...
    public static final Set<String> ANTICHEATS = Set.of(
    ...
    public static final Set<String> VANILLA_NAMESPACES = Set.of(
        "minecraft", "brigadier", "bukkit", "spigot", "paper", "purpur",
        "velocity", "bungeecord", "waterfall"
    );

    public static final class PluginScanEntry {
        String displayName;
    ...
    public static final class PluginProbeSpec {
        final String query;
    ...
    public static final class PluginProbeRequest {
        final int id;
    ...
    public static final class PluginListRow {
        final boolean header;
        final String title;
        final String plugin;
        final PluginEvidence evidence;

        public PluginListRow(boolean header, String title, String plugin, PluginEvidence evidence) {
            this.header = header;
            this.title = title;
            this.plugin = plugin;
    ...
    public void addInfoRow(String label, String value, Integer valueColor) {
        addInfoRow(label, value, valueColor, null);
    }

    public void addInfoRow(String label, String value, Integer valueColor, Runnable onPress) {
    ...
    public void buildPluginSetupUi() {
    ...
    public void buildPluginScanningUi() {
    ...
    public void buildPluginResultsUi() {
    ...
    public String normalizePluginContextSignature(String signature) {
        return signature == null ? "" : signature.trim().toLowerCase(Locale.ROOT);
    }

    public String currentPluginContextSignature() {
    ...
    public void invalidatePluginContextSignature() {
        pluginContextSignatureDirty = true;
    }

    public void setPluginProbeDelayMs(int delayMs) {
    ...
    public void applyClampedBounds() {
    ...
    public int getPluginSetupPanelHeight() {
        PackUiViewport viewport = surface.viewport();
    ...
    public int getPluginScanningPanelHeight() {
        PackUiViewport viewport = surface.viewport();
    ...
    public int getPluginResultsReservedHeight() {
    ...
    public int measurePreferredInfoPanelHeight() {
    ...
    public int measurePreferredHeightForState(int tab, boolean scanDone, boolean scanInProgress, int measureWidth) {
    ...
    public int getInfoRequiredHeight() {
        int rowCount = 11;
        String displayedAddress = getDisplayedServerAddress();
        String host = extractLookupHost(displayedAddress);
        String realIp = getDisplayedRealIp(displayedAddress);
    ...
    public void rememberCurrentTabSize() {
        if (activeTab == 0) {
    ...
    public void clearLocalScanState(String address, String contextSignature) {
    ...
    public boolean loadCachedScan(String address, String contextSignature) {
    ...
    public void syncScanStateForCurrentServer() {
        String currentAddress = currentServerAddress();
    ...
    public String normalizePluginKey(String plugin) {
        return plugin == null ? "" : plugin.trim().toLowerCase(Locale.ROOT);
    }

    public int evidenceRank(PluginEvidence evidence) {
    ...
    public PluginEvidence mergeEvidence(PluginEvidence current, PluginEvidence candidate) {
    ...
    public PluginEvidence parseEvidenceName(String value) {
    ...
    public String getEvidenceTitle(PluginEvidence evidence) {
        return switch (evidence) {
    ...
    public int getEvidenceColor(PluginEvidence evidence, boolean hovered) {
    ...
    public Map<String, PluginScanEntry> buildCurrentPluginEntries() {
    ...
    public void mergePluginEntry(Map<String, PluginScanEntry> entries, String pluginName, Collection<String> commands, boolean commandBacked, PluginEvidence evidence) {
    ...
    public void applyPluginEntries(Map<String, PluginScanEntry> entries, boolean resetSelection) {
        detectedPlugins.clear();
        pluginCommands.clear();
    ...
    public boolean isKnownPluginNamespace(String key) {
    ...
    public String normalizeCommandToken(String raw) {
        if (raw == null) return "";
    ...
    public boolean isLikelyPluginNameCandidate(String candidate, PluginProbeKind kind) {
    ...
    public void addObservedPluginCommand(String raw) {
    ...
    public void inferPluginsFromObservedCommands(Map<String, PluginScanEntry> entries) {
    ...
    public int addProbeVariants(Map<Integer, PluginProbeSpec> probes, int nextId, PluginProbeKind kind, String... baseCommands) {
    ...
    public Map<Integer, PluginProbeSpec> buildPluginProbes() {
    ...
    public void finalizePluginScan() {
    ...
    public void dispatchQueuedPluginProbes() {
    ...
    public long getPluginScanHardTimeoutMs() {
    ...
    public String getPluginScanStatusLabel() {
        int foundCount = getDisplayedPluginCount();
        if (foundCount > 0) {
    ...
    public void announcePluginScanComplete() {
    ...
    public void updatePluginScanLifecycle() {
    ...
    public void parseCommandTree(com.mojang.brigadier.tree.RootCommandNode<?> root) {
        Map<String, PluginScanEntry> entries = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    ...
    public String getReportedVersion(ServerData entry) {
        return entry != null && entry.version != null ? entry.version.getString() : "--";
    }

    public String getRealServerVersion() {
    ...
    public String extractVersionFromBrand(String brand) {
    ...
    public void renderPluginResultsViewport(GuiGraphicsExtractor ctx, PackUiViewport viewport, float uiMouseX, float uiMouseY, float delta) {
    ...
    public PackUiScrollbar.Metrics getPluginScrollbarMetrics(int x, int y, int width, int height) {
    ...
    public int buttonRowGap() {
        return 2;
    }

    public int infoLabelWidth() {
        return 64;
    }

    public int pluginSetupLabelWidth() {
        return 46;
    }

    public int pluginScanLabelWidth() {
        return 40;
    }

    public int pluginSearchWidth() {
        return 128;
    }

    public int pluginSearchReserveWidth() {
        return 28;
    }

    public float pluginViewportMinHeight() {
        return 66.0f;
    }

    public int sharedPanelWidth() {
        return 204;
    }

    public int pluginSetupWidth() {
        return sharedPanelWidth();
    }

    public int pluginScanningWidth() {
        return sharedPanelWidth();
    }

    public int infoMinWidth() {
        return sharedPanelWidth();
    }

    public int infoMinHeight() {
        return 246;
    }

    public int pluginResultsMinWidth() {
        return sharedPanelWidth();
    }

    public int pluginResultsMinHeightPreset() {
        return 266;
    }

    public int pluginSetupHeight() {
        return 120;
    }

    public int pluginScanningHeight() {
        return 92;
    }

    public int viewportHeightMargin() {
        return 24;
    }

    public int pluginHeaderHeight() {
        return pluginListRowStep();
    }

    public int pluginRowHeight() {
        return 15;
    }

    public int pluginDetailRowHeight() {
        return pluginListRowStep();
    }

    public int pluginDetailPadding() {
        return 0;
    }
    ...
    public int pluginListRowStep() {
        return pluginRowHeight();
    }

    public int getPluginlistViewportHeight(int rawHeight) {
        if (rawHeight <= 0) return 0;
        return Math.min(rawHeight, getPluginListInnerHeight(rawHeight) + 2);
    }

    public int getPluginListInnerHeight(int viewHeight) {
    ...
    public String getSoftwareGuess(ServerData entry) {
    ...
    public String getVersionNote(ServerData entry) {
        String brand = getLiveBrand();
    ...
    public String getDisplayedServerAddress() {
        ServerData entry = MC.getCurrentServer();
        if (entry != null && entry.ip != null && !entry.ip.isBlank()) {
    ...
    public String extractLookupHost(String rawAddress) {
    ...
    public Integer extractPort(String rawAddress) {
    ...
    public String appendPortIfPresent(String host, Integer port) {
    ...
    public void copyClipboardValue(String value, String successMessage, String unavailableMessage) {
    ...
    public void copyResolvedServerIp() {
        String displayedAddress = getDisplayedServerAddress();
        String realIp = getDisplayedRealIp(displayedAddress);
    ...
    public void ensureResolvedIpLookup(String rawAddress) {
    ...
    public String getDisplayedRealIp(String rawAddress) {
    ...
    public List<PluginListRow> buildPluginRows(List<String> filteredPlugins) {
    ...
    public int estimatePluginContentHeight(List<PluginListRow> rows) {
        int total = 0;
        for (PluginListRow row : rows) {

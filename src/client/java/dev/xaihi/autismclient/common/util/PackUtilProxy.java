...
public class PackUtilProxy {
    ...
    public int checkType(PackUtilProxyType checkType, int timeoutMs) {
        try {
    ...
    public boolean isSocks4(int timeoutMs) throws IOException {
        ByteBuffer bb;
    ...
    public boolean isSocks5(int timeoutMs) throws IOException {
    ...
    public byte[] sendData(byte[] data, int read, int timeoutMs) throws IOException {

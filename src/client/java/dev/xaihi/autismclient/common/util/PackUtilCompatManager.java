...
public final class PackUtilCompatManager {
    public static final String METEOR_MACROS_CLASS = "meteordevelopment.meteorclient.systems.macros.Macros";
    public static final String METEOR_MACRO_CLASS = "meteordevelopment.meteorclient.systems.macros.Macro";
    public static final String METEOR_MODULES_CLASS = "meteordevelopment.meteorclient.systems.modules.Modules";
    public static final String BARITONE_API_CLASS = "baritone.api.BaritoneAPI";
    public static final String BARITONE_GOAL_CLASS = "baritone.api.pathing.goals.Goal";
    public static final String BARITONE_GOAL_BLOCK_CLASS = "baritone.api.pathing.goals.GoalBlock";

    public PackUtilCompatManager() {
    }
    ...
    public static PackUtilMacro convertMeteorMacro(Object meteorMacro) {
    ...
    public static Object getMeteorMacrosSystem() throws Exception {
    ...
    public static Object getMeteorModulesSystem() throws Exception {
        Class<?> modulesClass = Class.forName(METEOR_MODULES_CLASS);
        Method getMethod = modulesClass.getMethod("get");
        return getMethod.invoke(null);
    }

    public static Object getPrimaryBaritone() throws Exception {
    ...
    public static Object getSettingValue(Object owner, String fieldName) throws Exception {
    ...
    public static void setSettingValue(Object owner, String fieldName, Object value) throws Exception {
        Object setting = getFieldValue(owner, fieldName);
    ...
    public static boolean queryBaritoneProcessActive(String getterName) {
        if (!isBaritoneAvailable()) return false;
    ...
    public static boolean queryProcessActive(Object baritone, String getterName) throws Exception {
        Object process = invokeMethod(baritone, getterName);
        return invokeBoolean(process, "isActive");
    }

    public static boolean invokeBoolean(Object target, String methodName) throws Exception {

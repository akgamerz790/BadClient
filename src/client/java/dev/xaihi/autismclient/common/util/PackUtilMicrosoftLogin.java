...
public final class PackUtilMicrosoftLogin {
    ...
    public static volatile HttpServer server;
    public static volatile Consumer<String> callback;

    public PackUtilMicrosoftLogin() {
    }
    ...
    public static boolean hasGameOwnership(JsonObject ownership) {
    ...
    public static void handleRequest(HttpExchange request) throws IOException {
    ...
    public static void writeText(HttpExchange request, String text) throws IOException {
    ...
    public static List<Tuple<String, String>> parseURL(String string) {

...
public class PackUtilClipboardHelper {
    public static final int CLIPBOARD_VERSION = 1;
    public static final String MACRO_CLIPBOARD_TYPE = "packutil_macro";
    ...
    public static CompoundTag serializePacket(Packet<?> packet) {
        CompoundTag tag = new CompoundTag();
    ...
    public static Packet<?> deserializePacket(CompoundTag tag) {
        try {
    ...
    public static void serializeFields(Object obj, CompoundTag fieldsTag) {
    ...
    public static void serializeField(CompoundTag tag, String name, Object value, Class<?> type) {
        if (value == null) {
    ...
    public static void serializeInt2ObjectMap(CompoundTag tag, String name, Int2ObjectMap<?> map) {
    ...
    public static void serializeMap(CompoundTag tag, String name, Map<?, ?> map) {
        CompoundTag mapTag = new CompoundTag();
        int index = 0;
    ...
    public static void serializeList(CompoundTag tag, String name, List<?> list) {
    ...
    public static void deserializeFields(Object obj, CompoundTag fieldsTag) {
        Class<?> clazz = obj.getClass();
    ...
    public static Object deserializeField(CompoundTag tag, String name, Class<?> targetType) {
    ...
    public static Int2ObjectMap<Object> deserializeInt2ObjectMap(CompoundTag mapTag) {
    ...
    public static Map<Object, Object> deserializeMap(CompoundTag mapTag) {
    ...
    public static List<Object> deserializeList(ListTag listTag) {
    ...
    public static Object deserializeRecord(Class<?> recordClass, CompoundTag fieldsTag) throws Exception {
    ...
    public static Object getSafeDefault(Class<?> type, String fieldName) {

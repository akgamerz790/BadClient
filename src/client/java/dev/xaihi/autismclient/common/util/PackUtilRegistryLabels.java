...
public final class PackUtilRegistryLabels {
    public static final Map<String, String> ITEM_CACHE = new ConcurrentHashMap<>();
    public static final Map<String, String> BLOCK_CACHE = new ConcurrentHashMap<>();
    public static final Map<String, String> ENTITY_CACHE = new ConcurrentHashMap<>();
    public static final Map<String, String> IDENTIFIER_CACHE = new ConcurrentHashMap<>();

    public PackUtilRegistryLabels() {
    }
    ...
    public static <T> String registryLabel(String rawId, Registry<T> registry, Function<T, String> nameProvider) {
    ...
    public static String humanizeIdentifier(String rawId) {
        if (rawId.isEmpty()) return "";
        Identifier parsed = Identifier.tryParse(rawId);
    ...
    public static String humanizeWords(String raw) {
    ...
    public static String normalizedKey(String rawId) {

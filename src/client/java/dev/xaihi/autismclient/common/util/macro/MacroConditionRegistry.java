...
public class MacroConditionRegistry {
    ...
    public static final List<PendingCondition> pendingConditions = Collections.synchronizedList(new ArrayList<>());
    ...
    static class GuiCloseCondition implements PendingCondition {
        ...
        final CompletableFuture<Void> future;
        public volatile boolean cancelled = false;
        public boolean sawMatchingGui = false;
    ...
    static class BlockCondition implements PendingCondition {
        ...
        public boolean isAtPosReachable(Minecraft mc) {
    ...
    static class EntityCondition implements PendingCondition {
        ...
        public boolean entityMatches(net.minecraft.world.entity.Entity entity) {
    ...
    static class SlotChangeCondition implements PendingCondition {
        ...
        public boolean checkEntry(Minecraft mc,
        ...
        public boolean checkStack(ItemStack stack, ItemTarget target, int visibleSlot,
    ...
    public static String snapshotStackIdentity(ItemStack stack) {
    ...
    static class LanStepCondition implements PendingCondition {
        ...
        public boolean anyOtherPeerReached(java.util.Map<String, Integer> steps, String myUsername, int targetStep) {
            for (java.util.Map.Entry<String, Integer> entry : steps.entrySet()) {
                if (entry.getKey().equals(myUsername)) continue;
    ...
    public static boolean matchesLower(String searchLower, String[] searchWords, String target) {
    ...
    public static boolean matchesText(String search, String target) {

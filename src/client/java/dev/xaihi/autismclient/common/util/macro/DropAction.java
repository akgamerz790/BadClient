...
public class DropAction implements MacroAction, WaitsForGui {
    ...
    public void dropMatchingItemInSpecificSlot(Minecraft mc, int configuredSlot, String itemName, int count) {
        dropMatchingItemInSpecificSlot(mc, configuredSlot, ItemTarget.fromLegacyEntry(itemName), count);
    }

    public void dropMatchingItemInSpecificSlot(Minecraft mc, int configuredSlot, ItemTarget target, int count) {
    ...
    public void dropMatchingItemsByName(Minecraft mc, String itemName, int count) {
        dropMatchingItemsByTarget(mc, ItemTarget.fromLegacyEntry(itemName), count);
    }

    public void dropMatchingItemsByTarget(Minecraft mc, ItemTarget target, int count) {
        if (!target.hasIdentity()) return;
        int remaining = count;
        if (useHandlerSlots) {
            AbstractContainerMenu handler = mc.player.containerMenu;
    ...
    public void dropFromInvSlot(Minecraft mc, int invSlot, int count) {
        PackUtilDropHelper.dropFromInventorySlot(mc, invSlot, count);
    }

    public void dropFromHandlerSlot(Minecraft mc, int handlerSlotId, int count) {

...
public class LookAtBlockAction implements MacroAction {
    ...
    public RotationTarget resolveNearestBlockTarget(Minecraft mc) {
    ...
    public RotationTarget resolveNearestEntityTarget(Minecraft mc) {
    ...
    public boolean matchesEntity(Entity entity, Set<String> typeIds, Set<String> specificUuids) {
        if (specificUuids.contains(entity.getStringUUID())) return true;
        String typeId = BuiltInRegistries.ENTITY_TYPE.getKey(entity.getType()).toString();
        return typeIds.contains(typeId);
    }

    public String formatBlockTargets() {
    ...
    public String formatEntityTargets() {
    ...
    public static RotationTarget rotationTo(Vec3 from, Vec3 to) {
